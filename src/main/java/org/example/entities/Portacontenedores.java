...
public class Portacontenedores extends Buque {
	...
	public Portacontenedores(String codigoIMO, String nombre, Double caladoMaximo, Integer numeroMaximoTEUs,
			String tipoGrua) {
	...
	public Integer getNumeroMaximoTEUs() {
		return numeroMaximoTEUs;
	}

	public void setNumeroMaximoTEUs(Integer numeroMaximoTEUs) {
		this.numeroMaximoTEUs = numeroMaximoTEUs;
	}
